...
namespace :ridgepole do
  ...
  desc 'Creates the database, loads the schema, and initializes with the seed data if database does not exist' \
       ', or updates the schema if it does (like db:prepare)'
